...
import { useDeleteBranchMutation } from "@/redux/api/branchApi";
...
export default function DeleteBranchModal({ branch, onClose }: DeleteBranchModalProps) {
                ...
                <div className="p-8 text-center space-y-4">
                    ...
                    <div className="space-y-2">
                        ...
                        <p className="text-slate-500 text-sm font-medium">
                            Are you sure you want to delete <span className="text-slate-900 font-bold">"{branch.branch_name}"</span>? This action cannot be undone.
                        </p>
                    </div>
